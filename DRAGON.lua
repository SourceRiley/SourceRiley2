...
local keyboard = {
{'حزين'},
{'◉ الاحصائيات','◉ ضع اسم للبوت'},
{'◉ قسم الحمايه','◉ قـسم الـسورس','◉ قـسم الاذاعـه'},
{'قناه السورس يقمدد','◉ قـسم مـسح↚اضـف','قـسم تـفعيل↚تـعطيل'},
{'جوو'},
{'◉ جلب المشتركين','◉ جلب النسخه','◉ الاصدار'},
{'◉ جلب المطورين','تحديث السورس','◉ جلب التوكن'},
{'جلب الثانوين ◉'},
{'قناه السورس يقمدد ','معلومات السيرفر'},
{'الغاء'},
}
send_inline_key(msg.chat_id_,bl,keyboard)
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥??𝗟𝗘𝗬 𖠛 𖠗》˼', url="t.me/SourceRiley"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/S_AD_26/10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 「 رتبتڪ 」 ⇇"..Rutba(msg.sender_user_id_,msg.chat_id_).." . ", msg.id_, msg.id_, "md")
else
...
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," انـت "..Rutba(msg.sender_user_id_,msg.chat_id_).." روح قلبي 🥺❤️", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
