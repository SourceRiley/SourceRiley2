...
send(msg.chat_id_, msg.id_,' *♕︎⤈︙تم تفعيل اليوتيوب*') 
return false  
end
if text == 'تعطيل اليوتيوب' and Mod(msg) then  
bot_data:set(ban_id..'searchinbot'..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,' *♕︎⤈︙تم تعطيل اليوتيوب*') 
return false  
end
