...
keyboard = {}
keyboard.inline_keyboard = {
{{text = '𝐃𝐞𝐯 𝐀𝐡𝐦𝐞𝐝',url="t.me/Ahmed_Riley"}},
{{text = '𝙈𝙀𝘿𝙊𝙓𝙓',url="t.me/M3d0X"}},
{{text = '𝐊𝐎𝐊𝐎',url="t.me/koko_Egypts_star"}},
{{text = '𝙀𝙇𝙆𝙃𝘼𝙏𝙄𝘽',url="t.me/E_l_k_e_a_t_i_b"}},
{{text = '𝐒𝐀𝐃',url="t.me/Wzniii"}},
...
if text == 'بوت يوتيوب' or text == 'يوتيوب' or text == 'يت' then
local Text = [[
[اليك بوتات تحميل 🌜
من جميع المواقع 🌝](t.me/SourceRiley)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/xiex_c/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{
{text = '𝐂𝐇 𝗥𝗜𝗟𝗘𝗬', url="t.me/SourceRiley"}, 
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المبرمج نن عيني 🥺🤍](t.me/SourceRiley)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/SourceRiley)') 
return false
end
...
if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[عضو قميل 🌝💙](t.me/SourceRiley)') 
return false
end
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه كوكو ') 
return false
end
