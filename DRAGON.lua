...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/SourceRiley/156&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹koko˼', url="t.me/koko_Egypts_star"},{text = '˹Riley˼', url="t.me/Ahmed_Riley2"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Riley's yard🏂💖',url="t.me/SourceRiley2"}},
{{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
{{text = ' بوت كوكو',url="t.me/@kokoxo_bot"},{text = 'بوت ريكا', url="t.me/HatakeKakashl_bot"}},
...
keyboard.inline_keyboard = {
{{text = '˹ Riley ˼',url="t.me/Ahmed_Riley"}},
{{text = '˹ T A W O S L ˼ ',url="t.me/HatakeKakashl_bot"}}, 
{{text = ' ˹B A C K ˼', callback_data="/HHH"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
