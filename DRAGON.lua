...
sudo_users = {SUDO,1878891780,1443455396}   
...
{{text = '˹Riley˼', url="t.me/Ahmed_Riley"}}, 
...
if text == 'سيلفر ريلي' or text == 'رايلي' or text == 'المبرمج رايلي' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
...
if text == 'استوري رايلي' or text == 'كوكب رايلي' or text == 'قناه المبرمج رايلي' or text == 'متيجي' or text == 'متيقي' then
local Text = [[
...
if text == 'العاب سيلفر ريلي' or text == 'العاب مطوره' or text == 'العاب متطوره' or text == 'العاب' then    
local Text = [[  
...
local Text = '['..AY..'](t.me/SourceRiley)'
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[رتبتك المبرمج رايلي🥺🤍](t.me/SourceRiley)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[المطور الاساسي🥺🤍](t.me/SourceRiley)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[المطور الاساسي²  😍💚](t.me/SourceRiley)') 
return false
end

if text == 'رتبتي' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[ المطور 🌝💘](t.me/SourceRiley)') 
return false
end

if text == 'رتبتي' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[المالك 🌚💘](t.me/SourceRiley)') 
return false
end

if text == 'رتبتي' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[المنشئ اساسي 🤦‍♂️](t.me/SourceRiley)') 
return false
end

if text == 'رتبتي' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ المنشئ😂💘](t.me/SourceRiley)') 
return false
end

if text == 'رتبتي' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[المدير الجامد😹](t.me/SourceRiley)') 
return false
end

if text == 'رتبتي' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[الادمن 😹 ](t.me/SourceRiley)') 
return false
end

if text == 'رتبتي' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ المميز حبيبي الكل 😊 ](t.me/SourceRiley)') 
return false
end
